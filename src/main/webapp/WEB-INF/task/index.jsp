...
<div class="container">
    ...
    <s:iterator value="list" status="st">
        <s:if test="#st.first"><div class="card-deck  mt-5"></s:if>
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">单号:<s:property value="taskId"/></h5>
        ...
        <s:if test="#st.count % 3 == 0 "></div><div class="card-deck  mt-5"></s:if>
    </s:iterator>
    <s:if test="#st.count % 3 == 0 "> </div></s:if>
