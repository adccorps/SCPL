    ...
    <form>
        ...
        <div class="form-row">
            <div class="col">
                ...
                <input type="text" class="form-control company" id="company" name="task.taskCompany" required>
        ...
        <div class="form-row">
            <div class="col">
                ...
                <textarea class="form-control" id="message" rows="3" name="task.taskMessage"></textarea>
            </div>
        </div>
    </form>
    <div class="row mt-4">
